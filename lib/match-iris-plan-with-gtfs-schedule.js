...
`
	...
	${firstCte ? '' : ', '}${alias} AS NOT MATERIALIZED (
		...
		LEFT JOIN stops_normalized_names snn ON ad.stop_id = snn.stop_id
		WHERE True
${genericFilters}
`
...
SELECT
	...
	snn.normalized_name AS stop_normalized_name,
	t_arrival,
	t_departure
	-- todo: use tz
FROM arrivals_departures ad
