...
const formatMatchedScheduleStopTimesAsGtfsRtTripUpdate = (matchedStopTimes) => {
	...
	return {
		...
		stop_time_update: matchedStopTimes.map((stopTime) => {
			...
			Object.defineProperty(stu, kNormalizedStopName, {value: stop_normalized_name})
			Object.defineProperty(stu, kStopLatitude, {value: stop_lat})
			Object.defineProperty(stu, kStopLongitude, {value: stop_lon})
			return stu
		}),
	}
}
